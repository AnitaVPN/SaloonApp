...
//    cell.vwServices.layer.shadowOffset = CGSizeMake(1, 0);
//    cell.vwServices.layer.shadowColor = [[UIColor lightGrayColor] CGColor];
//    cell.vwServices.layer.shadowRadius = 3;
//    cell.vwServices.layer.shadowOpacity = .5;
//    cell.vwServices.clipsToBounds = false;
//
//    cell.vwProducts.layer.shadowOffset = CGSizeMake(1, 0);
//    cell.vwProducts.layer.shadowColor = [[UIColor lightGrayColor] CGColor];
//    cell.vwProducts.layer.shadowRadius = 3;
//    cell.vwProducts.layer.shadowOpacity = .5;
//    cell.vwProducts.clipsToBounds = false;
//
//
//    cell.vwAssistance.layer.shadowOffset = CGSizeMake(1, 0);
//    cell.vwAssistance.layer.shadowColor = [[UIColor lightGrayColor] CGColor];
//    cell.vwAssistance.layer.shadowRadius = 3;
//    cell.vwAssistance.layer.shadowOpacity = .5;
//
//    cell.vwAssistance.clipsToBounds = false;
//
//
//    cell.vwAmount.layer.shadowOffset = CGSizeMake(1, 0);
//    cell.vwAmount.layer.shadowColor = [[UIColor lightGrayColor] CGColor];
//    cell.vwAmount.layer.shadowRadius = 3;
//    cell.vwAmount.layer.shadowOpacity = .5;
//    cell.vwAmount.clipsToBounds = false;
//
//
