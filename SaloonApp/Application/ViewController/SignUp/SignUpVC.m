...
-(void)setup
{
    ...
    if(_isFromBranchManager)
    {
        _appLogo.hidden = true;
        _vwTop1.hidden = false;
    }
    ...
    if(AppDeleObj.userType == 1)
    {
        ...
        [[Utils sharedInstance] setupTextFeild:_txtName :APP_BUTTONS_COLOR :YES :[UIImage imageNamed:@"icon_user"] :@" Enter name"];
        
        [[Utils sharedInstance] setupTextFeild:_txtEmail :APP_BUTTONS_COLOR :YES :[UIImage imageNamed:@"icon_email"] :@"Enter email address"];
        
        [[Utils sharedInstance] setupTextFeild:_txtMobileNumber :APP_BUTTONS_COLOR :YES :[UIImage imageNamed:@"icon_phone"] :@" Enter phone number"];
    ...
    else if(AppDeleObj.userType == 3)
    {
        ...
        [[Utils sharedInstance] setupTextFeild:_txtExixstingUser_mobiileNumber :APP_BUTTONS_COLOR :YES :[UIImage imageNamed:@"icon_phone"] :@" Enter Mobile Number"];
    ...
    else
    {
        ...
        [[Utils sharedInstance] setupTextFeild:_txt_pos_email_address :APP_BUTTONS_COLOR :YES :[UIImage imageNamed:@"icon_user"] :@"Enter username"];
        
        [[Utils sharedInstance] setupTextFeild:_txt_pos_password :APP_BUTTONS_COLOR :YES :[UIImage imageNamed:@"icon_password"] :@" Enter password"];
...
- (IBAction)btnRegClickEvent:(id)sender {
    ...
    else
    {
        ...
        if(_isFromBranchManager)
        {
            [[Utils sharedInstance] showAlert:@"User Add Sucessfully" :self];
            return;
        }
